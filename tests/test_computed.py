...
class TestShortenClassification:
    ...
    @pytest.mark.parametrize("raw", [
        "AOP / AOC", "AOC / DOC", "DOP / DOC", "DOCG",
        "IGT / IGP", "IGP / Vinho Regional", "Vin de Pays",
...
class TestComputeFullName:
    def test_bordeaux_no_name(self):
        assert compute_full_name(
            winery="Château Suduiraut", name=None,
            subregion="Sauternes", classification="1er Grand Cru Classé",
            grape_type="blend", primary_grape="Sémillon",
            grape_summary="Sémillon / Sauvignon Blanc",
            vintage=2011, is_nv=False,
        ) == "Château Suduiraut Sauternes 1er Grand Cru Classé 2011"

    def test_italian_docg(self):
        assert compute_full_name(
            winery="Boscaini Carlo", name=None,
            subregion="Amarone della Valpolicella Classico",
            classification="DOCG Riserva",
            grape_type="unknown", primary_grape=None, grape_summary=None,
            vintage=2015, is_nv=False,
        ) == "Boscaini Carlo Amarone della Valpolicella Classico Riserva 2015"

    def test_named_wine_not_ambiguous(self):
        assert compute_full_name(
            winery="Negro Giuseppe", name="Barbaresco Gallina",
            subregion="Barbaresco", classification="DOCG Riserva",
            grape_type="varietal", primary_grape="Nebbiolo",
            grape_summary="Nebbiolo",
            vintage=2020, is_nv=False,
            name_needs_grape=False,
        ) == "Negro Giuseppe Barbaresco Gallina 2020"

    def test_grape_ambiguous_varietal(self):
        assert compute_full_name(
            winery="Spier", name="21 Gables",
            subregion="Stellenbosch", classification=None,
            grape_type="varietal", primary_grape="Chenin Blanc",
            grape_summary="Chenin Blanc",
            vintage=2022, is_nv=False,
    ...
    def test_grape_ambiguous_varietal_other(self):
        assert compute_full_name(
            winery="Spier", name="21 Gables",
            subregion="Stellenbosch", classification=None,
            grape_type="varietal", primary_grape="Cabernet Sauvignon",
            grape_summary="Cabernet Sauvignon",
            vintage=2017, is_nv=False,
            name_needs_grape=True,
        ) == "Spier 21 Gables Cabernet Sauvignon 2017"

    def test_grape_ambiguous_blend(self):
        assert compute_full_name(
            winery="Pago de Cirsus", name="La Torre",
            subregion=None, classification=None,
            grape_type="blend", primary_grape="Syrah",
    ...
    def test_grape_ambiguous_varietal_chardonnay(self):
        assert compute_full_name(
            winery="Pago de Cirsus", name="La Torre",
            subregion=None, classification=None,
            grape_type="varietal", primary_grape="Chardonnay",
            grape_summary="Chardonnay",
            vintage=2023, is_nv=False,
            name_needs_grape=True,
        ) == "Pago de Cirsus La Torre Chardonnay 2023"

    def test_grape_ambiguous_unknown_grape_fallback(self):
        assert compute_full_name(
            winery="Vins Bruchez", name="Creation Lydi's",
            subregion="Valais", classification=None,
            grape_type="unknown", primary_grape=None,
            grape_summary=None,
            vintage=2024, is_nv=False,
            name_needs_grape=True,
        ) == "Vins Bruchez Creation Lydi's 2024"

    def test_nv_with_name(self):
        assert compute_full_name(
            winery="Champagne Pommery", name="Apanage Blanc de Blancs",
            subregion="Champagne", classification="AOP / AOC",
            grape_type="varietal", primary_grape="Chardonnay",
            grape_summary="Chardonnay",
            vintage=None, is_nv=True,
        ) == "Champagne Pommery Apanage Blanc de Blancs NV"

    def test_nv_without_name(self):
        assert compute_full_name(
            winery="Mionetto", name=None,
            subregion="Prosecco Treviso", classification=None,
    ...
    def test_spanish_rioja_reserva(self):
        assert compute_full_name(
            winery="Bodegas Bilbaínas", name=None,
            subregion="Rioja", classification="DOCa Reserva",
            grape_type="varietal", primary_grape="Tempranillo",
            grape_summary="Tempranillo",
            vintage=2016, is_nv=False,
        ) == "Bodegas Bilbaínas Rioja Reserva 2016"

    def test_new_world_varietal_no_name(self):
        assert compute_full_name(
            winery="Decoy Wines", name=None,
            subregion="Sonoma County", classification=None,
            grape_type="varietal", primary_grape="Cabernet Sauvignon",
            grape_summary="Cabernet Sauvignon",
            vintage=2021, is_nv=False,
        ) == "Decoy Wines Sonoma County 2021"

    def test_no_subregion_single_grape(self):
        assert compute_full_name(
            winery="Le Vigne Di Zamò", name=None,
            subregion=None, classification=None,
    ...
    def test_minimal_winery_only(self):
        assert compute_full_name(
            winery="Massimago", name=None,
            subregion=None, classification=None,
            grape_type="unknown", primary_grape=None,
            grape_summary=None,
            vintage=2019, is_nv=False,
        ) == "Massimago 2019"

    def test_no_winery(self):
        assert compute_full_name(
            winery=None, name=None,
            subregion=None, classification=None,
            grape_type="unknown", primary_grape=None,
            grape_summary=None,
            vintage=2020, is_nv=False,
    ...
    def test_truncation_at_80_chars(self):
        ...
        result = compute_full_name(
            winery=long_winery, name=None,
            subregion=long_subregion, classification="Grand Cru Classé",
            grape_type="unknown", primary_grape=None, grape_summary=None,
            vintage=2020, is_nv=False,
        )
...
class TestEnrichWines:
    def test_basic_enrichment(self):
        wines = [
            {
                "wine_id": 1, "winery_id": 1, "name": "Cuvée Alpha",
                "vintage": 2020, "is_non_vintage": False,
                "appellation_id": 1,
            },
        ]
        wine_grapes = [
    ...
    def test_grape_ambiguous_enrichment(self):
        wines = [
            {"wine_id": 10, "winery_id": 1, "name": "21 Gables",
             "vintage": 2022, "is_non_vintage": False, "appellation_id": None},
            {"wine_id": 11, "winery_id": 1, "name": "21 Gables",
             "vintage": 2017, "is_non_vintage": False, "appellation_id": None},
        ]
        wine_grapes = [
    ...
    def test_no_grapes(self):
        wines = [
            {"wine_id": 1, "winery_id": 1, "name": None,
             "vintage": 2019, "is_non_vintage": False, "appellation_id": None},
        ]
...
class TestComputeIsInTransit:
    ...
    def test_in_transit_when_configured(self):
        assert compute_is_in_transit(
            "99 Orders & Subscriptions", ("99 Orders & Subscriptions",),
        ) is True

    def test_not_in_transit_when_not_configured(self):
        assert compute_is_in_transit(
            "Home", ("99 Orders & Subscriptions",),
        ) is False
...
class TestConvertToDefaultCurrency:
    ...
    def test_unknown_currency_raises(self):
        with pytest.raises(ValueError, match="No exchange rate"):
            convert_to_default_currency(
                Decimal("20.00"), "GBP", "CHF", self.RATES,
            )

    def test_rounding_to_two_decimals(self):
        # AUD 33.33 × 0.56 = 18.6648 → 18.66
        result = convert_to_default_currency(
            Decimal("33.33"), "AUD", "CHF", self.RATES,
        )
        assert result == Decimal("18.66")

    def test_zero_price(self):
        result = convert_to_default_currency(
            Decimal("0.00"), "EUR", "CHF", self.RATES,
        )
        assert result == Decimal("0.00")

    def test_large_price(self):
        result = convert_to_default_currency(
            Decimal("5000.00"), "EUR", "CHF", self.RATES,
        )
...
class TestEnrichWinesPass3:
    def test_pass3_with_current_year(self):
        wines = [
            {
                "wine_id": 1, "winery_id": 1, "name": "Test",
                "vintage": 2020, "is_non_vintage": False,
                "appellation_id": None,
                "drink_from": 2022, "drink_until": 2035,
                "optimal_from": 2025, "optimal_until": 2030,
    ...
    def test_pass3_currency_conversion(self):
        wines = [
            {
                "wine_id": 1, "winery_id": 1, "name": "Euro Wine",
                "vintage": 2020, "is_non_vintage": False,
                "appellation_id": None,
    ...
    def test_pass3_null_price_stays_null(self):
        wines = [
            {
                "wine_id": 1, "winery_id": 1, "name": "No Price",
                "vintage": 2020, "is_non_vintage": False,
                "appellation_id": None,
                "drink_from": None, "drink_until": None,
                "optimal_from": None, "optimal_until": None,
