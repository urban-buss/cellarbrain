...
class TestWineFingerprint:
    def test_basic(self):
        ...
        assert wine_fingerprint(row) == (
            "750mL", "Grand Cru", "Merlot (80%)", "Red wine", "42.00",
        )
    ...
    def test_whitespace_stripped(self):
        row = {"volume_raw": " 750mL ", "classification": None, "grapes_raw": "", "category_raw": " Red wine", "list_price_raw": "42.00 "}
...
class TestAssignDossierPaths:
    ...
    def test_wine_with_only_gone_bottles_goes_to_archive(self, sample_wine_row):
        ...
        wines, _ = build_wines(rows, winery_lk, app_lk)
        gone_bottle = {
            "wine_id": 1, "status": "drunk", "cellar_id": None,
            "shelf": None, "bottle_number": None, "provider_id": None,
        }
    ...
    def test_wine_with_only_in_transit_bottles_goes_to_archive(self, sample_wine_row):
        ...
        wines, _ = build_wines(rows, winery_lk, app_lk)
        transit_bottle = {
            "wine_id": 1, "status": "stored", "is_in_transit": True,
    ...
    def test_wine_with_stored_and_in_transit_bottles_goes_to_cellar(
        self, sample_wine_row, sample_bottle_row,
    ):
        rows = [sample_wine_row]
        wineries, winery_lk = build_wineries(rows)
        _, app_lk = build_appellations(rows)
...
class TestBuildTrackedWines:
    def test_groups_by_winery_and_name(self):
        wines = [
            {"wine_id": 1, "winery_id": 10, "name": "Grand Vin", "vintage": 2020,
             "category": "red", "appellation_id": 1, "is_wishlist": True, "is_favorite": False},
            {"wine_id": 2, "winery_id": 10, "name": "Grand Vin", "vintage": 2018,
             "category": "red", "appellation_id": 1, "is_wishlist": True, "is_favorite": False},
        ]
        app_by_wine = {1: 1, 2: 1}
    ...
    def test_separate_names_create_separate_tracked(self):
        wines = [
            {"wine_id": 1, "winery_id": 10, "name": "Grand Vin", "vintage": 2020,
             "category": "red", "appellation_id": 1, "is_wishlist": True, "is_favorite": False},
            {"wine_id": 2, "winery_id": 10, "name": "Second Vin", "vintage": 2020,
             "category": "red", "appellation_id": 1, "is_favorite": True, "is_wishlist": False},
        ]
        app_by_wine = {1: 1, 2: 1}
        tracked, lk = build_tracked_wines(wines, app_by_wine)
    ...
    def test_no_wishlist_or_favorite_returns_empty(self):
        wines = [
            {"wine_id": 1, "winery_id": 10, "name": "Regular", "vintage": 2020,
             "category": "red", "appellation_id": 1, "is_wishlist": False, "is_favorite": False},
        ]
    ...
    def test_skips_wines_without_name(self):
        wines = [
            {"wine_id": 1, "winery_id": 10, "name": None, "vintage": 2020,
             "category": "red", "appellation_id": 1, "is_wishlist": True, "is_favorite": False},
        ]
        tracked, lk = build_tracked_wines(wines, {1: 1})
        assert tracked == []
    ...
    def test_favorite_creates_tracked(self):
        wines = [
            {"wine_id": 1, "winery_id": 10, "name": "Fav Wine", "vintage": 2020,
             "category": "white", "appellation_id": 2, "is_wishlist": False, "is_favorite": True},
        ]
    ...
    def test_tracked_wine_has_required_fields(self):
        wines = [
            {"wine_id": 1, "winery_id": 10, "name": "Test", "vintage": 2020,
             "category": "red", "appellation_id": 1, "is_wishlist": True, "is_favorite": False},
        ]
