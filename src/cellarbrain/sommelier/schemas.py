...
PROTEINS = frozenset({
    "red_meat", "poultry", "fish", "seafood",
    "pork", "game", "vegetarian", "vegan",
})

COOKING_METHODS = frozenset({
    "braised", "grilled", "roasted", "fried", "raw",
    "steamed", "baked", "smoked", "stewed", "sautéed",
    "poached", "fermented", "cured", "pickled", "no_cook",
    "simmered", "pan-fried", "stir-fried",
})
